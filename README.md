...
### 12. Deploy it to the public internet (Post 10)
...
costs, where the Post 3 abstractions finally cash in — is in
[Post 10](https://bearbearyu1223.github.io/posts/pepper-carrot-companion-shipping-it/).
...
- **A CI/CD pipeline.** The Post 10 deploy is `fly deploy` from a
