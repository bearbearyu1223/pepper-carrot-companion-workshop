...
Companion code for the first seven posts of the **Pepper & Carrot AI-powered flipbook** series. This repository is the minimum working dev environment a reader needs to reproduce every verification step in the blog posts.
...
Subsequent posts (Post 8 onwards — prompt hardening, world graph, cloud deploy) build on top of this scaffold in a separate repository.
